...
public class InterfaceCLI {
    ...
    public void receiptsResearch() throws IOException {
        ...
        URL url = new URL("https://api.spoonacular.com/recipes/findByIngredients?ingredients=" + ingredients + "&number=" + number + "&instructionsRequired=true&apiKey=6f941600fda4481f8f07381032a293b1");
        ...
        URL urlStep = new URL("https://api.spoonacular.com/recipes/" + JsonGestion.jsonGetId("id", numberArray-1, spoonacular3) + "/information?&instructionsRequired=true&apiKey=6f941600fda4481f8f07381032a293b1");
    ...
    public void favoriteReceipts() throws IOException {
        ...
        if(!file.exists()){
            ...
            URL url = new URL("https://api.spoonacular.com/recipes/" + JsonGestion.jsonReturnId(file, positionChoice) + "/information?&instructionsRequired=true&apiKey=6f941600fda4481f8f07381032a293b1");
            URLConnection spoonacular = url.openConnection();
